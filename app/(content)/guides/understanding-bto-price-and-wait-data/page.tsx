    ...
    <main className="content-main narrow-content">
      ...
      <article>
        ...
        <div className="article-body">
          <section><h2>Starting price is a project fact, not a household budget</h2><p>Where To BTO compares your maximum against HDB’s published starting price for the selected flat type. It does not calculate grants, loan eligibility, downpayment timing, optional components, renovation, or other household costs. A “pass” means only that the published starting price is within your screen.</p></section>
          <section><h2>Flat type must match</h2><p>A low starting price for a 2-room Flexi flat says nothing about whether the same project fits a 4-room budget. The tool requires the selected flat type to be present before it can make a price comparison.</p></section>
          <section><h2>Waiting time is an estimate</h2><p>Where HDB publishes one number, the tool displays that estimate. Where the source gives a range, the range stays intact. Estimated completion dates and waiting-time estimates are not rewritten as guaranteed key-collection dates.</p></section>
          <section><h2>Upcoming launches contain real unknowns</h2><p>An announcement can identify a town or future site before HDB publishes the project name, classification, exact coordinate, flat mix, prices, or wait. Those fields display “Not published by HDB yet” and remain neutral in matching.</p></section>
          <section><h2>Classification is not a quality score</h2><p>Standard, Plus, and Prime are published project classifications with policy implications. Where To BTO presents the field as a fact and does not convert it into a recommendation or hidden weighting.</p></section>
          <section><h2>Use the official decision gate</h2><p>Before applying, check the live HDB project page and your HDB Flat Eligibility letter. The independent map is a shortlist tool, not an eligibility, grant, loan, or application service.</p></section>
        </div>
